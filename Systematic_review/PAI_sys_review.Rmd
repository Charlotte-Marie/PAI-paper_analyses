...
data_study_char <-
  readxl::read_excel(path = "Extraction_PAI_studies_final_CM.xlsx", sheet = "study_characteristics_table",
...
save_as_docx(
  ft_sumtable,
  path = "C:\\Users\\charl\\Documents\\Promotion\\PAI-Paper\\Plots\\Table_1_study_characteristics.docx", pr_section = format_table_wide)
```
...
```{r}
data_study_char <-
  readxl::read_excel(path = "Extraction_PAI_studies_final_CM.xlsx", sheet = "subanalyses_cohens_d", na = "NA")
...
# Turn Author to factor again in reverse order
...
## Import data
```{r}
data_PROBAST <- readxl::read_excel(path = "PAI_PROBAST_assessment.xlsx", sheet = "Main")
...
# Save plot
plot_PROBAST
ggsave("figure_S1_PROBAST.svg",plot_PROBAST, height = 4.5, width = 9)
```
...
ggsave("C:\\Users\\charl\\Documents\\Promotion\\PAI-Paper\\Plots\\Figure_2_Cohens_d.svg", plot_2, units = "cm", width = 20.5, height = 12, dpi = 800)
ggsave("C:\\Users\\charl\\Documents\\Promotion\\PAI-Paper\\Plots\\Figure_2_Cohens_d.eps", plot_2, units = "cm", width = 20.5, height = 12, dpi = 800)

...
paths_advanced <- list(
  ...
  "panic.adv\n(ridgewhp)" = file.path(path_base,"old\\PANIK_net\\final_ridge_regression_no_one_hot_hp_tuned_grid"),
  "panic.adv\n(rf)" = file.path(path_base, "PANIK_net_random_forest"),
  "protect.adv\n(ridge)" = file.path(path_base,"PROTECT_AD_ridge_regression"),
  "protect.adv\n(ridgewhp)" = file.path(path_base,"old\\PROTECT_AD\\final_ridge_regression_no_one_hot_hp_tuned_grid"),
...
```{r}
path_trad<- list(
  "panic.trad\n(linear)"= file.path(path_base,"old\\PANIK_net\\final_traditional_approach_no_one_hot"),
  "protect.trad\n(linear)"= file.path(path_base,"old\\PROTECT_AD\\final_traditional_approach_no_one_hot_old")
)
```
